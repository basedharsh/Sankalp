...
class EntmtProjectScreen extends StatefulWidget {
  ...
  @override
  State<EntmtProjectScreen> createState() => _EntmtProjectScreenState();
}

class _EntmtProjectScreenState extends State<EntmtProjectScreen> {
  bool isLiked = false;
